...
def standard_method(df_train, df_test, model_path):
...
def norm(df_train, df_test, method, model_path, what_about_face):
    
    df_train, df_test = get_header(df_train, df_test, what_about_face)
    ...
    if method == "wh":
        ...
        df_train, df_test = standard_method(df_train, df_test, model_path)
